...
export default function Actualidad() {
  ...
  useEffect(() => {
    const loadNoticias = async () => {
      try {
        setLoading(true);
        const data = await apiService.getNoticias({ categoria: 'Actualidad' });
        setNoticias(data);
      } catch (err) {
          ...
          <article key={noticia.id} className="noticia-card">
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.target.src = "https://via.placeholder.com/400x200/333333/ffffff?text=Noticia+Actualidad";
                }}
              />
        ...
        >
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              className="modal-img"
              onError={(e) => {
                e.target.src = "https://via.placeholder.com/600x300/333333/ffffff?text=Noticia+Actualidad";
              }}
            />
